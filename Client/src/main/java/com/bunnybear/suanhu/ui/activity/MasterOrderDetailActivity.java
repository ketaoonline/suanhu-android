...
import com.bunnybear.suanhu.ui.adapter.MasterOrderDetailAdapter;
...
public class MasterOrderDetailActivity extends AppActivity {
    ...
    public static void open(AppActivity activity,String orderId) {
        ...
        activity.startActivity(bundle, MasterOrderDetailActivity.class);
    }

    List<Master> list = new ArrayList<>();
    MasterOrderDetailAdapter adapter;
    ...
    protected void init() {
        ...
        adapter = new MasterOrderDetailAdapter(list);
        ...
        Http.http.createApi(MineAPI.class)
                ...
                .subscribe(new AppSubscriber(new RequestCallBack<PayBean>() {
                    ...
                    public void success(PayBean result) {
                        if (isAliPay){
                            new AliPayUtil(MasterOrderDetailActivity.this,handler,result.getAlipay_info());
                        }else {
                            WXPayUtil.newInstance(MasterOrderDetailActivity.this).pay(MasterOrderDetailActivity.this,result.getWxpay_info(),"before");
                        }
                    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (payResult.getResultStatus()) {
                case "9000":
                    ...
                    break;
                case "6001":
                    ToastUtil.show(MasterOrderDetailActivity.this,"已取消支付");
                    break;
                default:
                    ToastUtil.show(MasterOrderDetailActivity.this,payResult.getResultStatus()+":"+payResult.getMemo());
                    break;
            }
        }
    };
    ...
    private void showDialog(){
        PaySuccessDialog dialog = new PaySuccessDialog.Builder(this).create();
        dialog.show();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                dialog.dismiss();
                BusFactory.getBus().post(new IEvent("Conversation", null));
            }
        },3000);
    }
