...
public class ExchangeCouponAdatper extends BaseQuickAdapter<Coupon,BaseViewHolder>{
    public ExchangeCouponAdatper(@Nullable List<Coupon> data) {
        super(R.layout.item_exchange_coupon, data);
    }
    ...
    protected void convert(BaseViewHolder helper, Coupon item) {
        ...
        helper.setText(R.id.tv_need_point,item.getCoupon_suanfen()+"\n积分兑换");
    }
}
